...
│   └── TaskDb.csproj                   
├── img/                                
│   ├── gitPushLab31-32_Zlamanyuk.png
│   ├── step4_migrationLab31-32_Zlamanyuk.png
│   ├── step5_crudLab31-32_Zlamanyuk.png
│   ├── step6_linqLab32_Zlamanyuk.png
│   ├── step7_migrationLab32_Zlamanyuk.png
│   └── step8_sqlLogsLab32_Zlamanyuk.png
├── .editorconfig
├── .gitignore
└── README.md
```
